...
void main() {
  ...
  testWidgets('login test with username and password and open dashboard',
    ...
    when(mockAuthUsecase.loginStudent('Aashish', 'Aashish123'))
    ...
    await tester.enterText(find.byType(TextField).at(0), 'Aashish');
    // Type in second textformfield
    await tester.enterText(find.byType(TextField).at(1), 'Aashish123');
